...
export function TechHighlight() {
  return (
    <section className="relative bg-cream-deep py-14 sm:py-20 md:py-32 overflow-hidden">
      <div className="container-wide grid gap-8 sm:gap-10 lg:gap-16 lg:grid-cols-12 items-center">
        ...
        <div className="lg:col-span-5">
          ...
          <Reveal delay={120}>
            <h2 className="mt-5 md:mt-6 font-serif text-[1.75rem] sm:text-3xl md:text-5xl lg:text-6xl leading-[1.12] tracking-tight text-balance text-ink">
              Onde a tecnologia{' '}
