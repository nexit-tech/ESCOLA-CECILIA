...
export function FeaturedFundamental() {
  return (
    <section className="relative bg-cream overflow-hidden">
      <div className="container-wide py-20 md:py-32 grid gap-12 lg:grid-cols-12 items-center">
        <Reveal direction="right" className="lg:col-span-6 order-2 lg:order-1">
          <div className="relative">
            ...
            <div className="absolute -bottom-5 -left-5 md:-bottom-6 md:-left-6 rounded-2xl bg-cream-deep px-5 py-4 shadow-soft ring-1 ring-ink/10 max-w-[220px]">
        ...
        <div className="lg:col-span-6 lg:pl-8 order-1 lg:order-2">
          ...
          <Reveal delay={120}>
            <h2 className="mt-6 font-serif text-3xl md:text-5xl lg:text-6xl leading-[1.05] tracking-tight text-balance text-ink">
